...
const allFiles = walk(path.join(process.cwd(), 'src', 'app'));
...
allFiles.forEach(f => {
    if (f.endsWith('page.tsx')) {
        ...
        if (content.includes('under construction')) {
            ...
            const title = match ? match[1] : 'Enterprise Solution';
            
            const newContent = `import HeroInner from '@/components/HeroInner';
...
export default function Page() {
  return (
    <>
      <HeroInner 
        title="${title}" 
        subtitle="Enterprise-grade ${title.toLowerCase()} engineered for scale, security, and operational efficiency."
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="max-w-none text-gray-600">
            ...
            <p className="mb-6 text-lg">
              We build ${title.toLowerCase()} that go beyond off-the-shelf capabilities. Our approach ensures that your systems are designed precisely around your operational reality, eliminating bottlenecks and enabling limitless scale.
            </p>
...
console.log('Updated ' + count + ' placeholder pages with professional layouts.');
