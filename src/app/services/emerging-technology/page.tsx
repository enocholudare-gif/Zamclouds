  ...
  return (
    <>
      <HeroInner 
        ...
        subtitle="Integration of IoT, Blockchain, and advanced emerging tech into your business."
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="max-w-none text-gray-600">
            ...
            <p className="mb-6 text-lg">
              We provide state-of-the-art Emerging Technology services that go beyond off-the-shelf capabilities. Our approach ensures that your systems are designed precisely around your operational reality, eliminating bottlenecks and enabling limitless scale.
            </p>
