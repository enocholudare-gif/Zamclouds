  ...
  return (
    <>
      <HeroInner 
        ...
        subtitle="Procurement of enterprise-grade servers, workstations, and network equipment."
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="max-w-none text-gray-600">
            ...
            <p className="mb-6 text-lg">
              We provide state-of-the-art Supplier of IT Hardware services that go beyond off-the-shelf capabilities. Our approach ensures that your systems are designed precisely around your operational reality, eliminating bottlenecks and enabling limitless scale.
            </p>
