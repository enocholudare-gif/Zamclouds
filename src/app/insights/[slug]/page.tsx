...
export default function Page() {
  return (
    <>
      <HeroInner 
        title="Detail Page" 
        subtitle="Enterprise-grade detail page engineered for scale, security, and operational efficiency."
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="max-w-none text-gray-600">
            ...
            <p className="mb-6 text-lg">
              We build detail page that go beyond off-the-shelf capabilities. Our approach ensures that your systems are designed precisely around your operational reality, eliminating bottlenecks and enabling limitless scale.
            </p>
